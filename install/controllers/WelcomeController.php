...
class WelcomeController extends Controller
{
    ...
    protected function validateRequest()
    {
        ...
        //$url        = 'http://www.mailwizz.com/api/license/' . $marketPlace;
        ...
        //$response = array('status' => 'success', 'license_data' => 'Loomy');
        $response = array(
            "status" => "success",
            "license_data" => array(
                "first_name" => "Nulled By ",
                "last_name" => "Loomy & GorillaFreak",
                "email" => "VIP@Bestblackhatforum.com",
                "market_place" => "Loomy's BDSM Dungeon",
                "purchase_code" => "42"
            ),
            "success" => true
        );
    ...
    {
        return array(
            'envato'    => 'Loomy\'s BDSM Dungeon',
            'mailwizz'  => 'Ancient Aliens',
        );
    }
