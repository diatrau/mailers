	...
	BounceHandler::COMMON_RULES          => array(
		array(
			...
			'regex'		 => array(
                ...
                '/smtp;550 (.*) Unfortunately, messages from (.*) weren\'t sent/i',
                '/smtp;554 ERROR: Mail Refused/i',
                '/smtp;(550|554) 5\.7\.1 Service unavailable/i',
                '/smtp;553 https:\/\/www\.spamhaus\.org\/sbl\/query\/SBLCSS/i',
                '/smtp;554 Message rejected for policy reasons/i',
                '/smtp;554 (.*) IP address is black(\s)?listed/i',
                '/smtp;554 (.*) poor reputation/i',
                '/smtp;550 Your IP (.*) is in RBL/i',
                '/smtp;522 IP FOUND IN DNSRBL/i',
                '/smtp;550 X-Warning: (.*) is in a black(\s)?list at (.*)/i',
                '/smtp;(550|552|554) spam ((e)?mail|message) rejected(.*)?/i',
                '/smtp;554 IP=(.*) - A problem occurred/i',
                '/smtp;554 Blocked - see/i',
                '/smtp;550 REJ-RELAY-001: relay not permitted/i',
                '/smtp;550 (.*) blocked for spamming issues/i',
                '/smtp;553 5\.3\.0 (.*) DNSBL/i',
                '/smtp;554 5\.5\.4 Mail contains unique UBE\/UCE characteristics/i',
                '/smtp;550 5\.7\.1 (.*)Relaying denied/i',
                '/smtp;554 (.*) ESMTP Blocked/i',
                '/smtp;550 (.*) Access denied, banned sending IP/i',
                '/smtp;501 Connection rejected by policy/i',
                '/smtp;550 ([a-z0-9]{40,})/i',
                '/smtp;550 This message was classified as SPAM/i',
                '/x-pmta;no compatible source IP configured/i',
                '/smtp;554 mx686\.syd\.oss-core\.com/i',
                '/smtp;554 (.*) spam detected/i',
                '/smtp;554 (.*) Message blocked due to spam content in the message/i',
                '/X-Postfix; mail for (.*) loops back to myself/i',
                '/smtp;550 5\.7\.1 Rejected - confirmed junk email/i',
                '/smtp;550 Administrative prohibition/i',
                '/smtp;550 Your email has not been delivered as it violates/i',
                '/smtp;(554|550) (Denied|Rejected)/i',
                '/smtp;550 (.*) Message detected as spam/i',
                '/smtp;550 5\.5\.0 550 5\.7\.1 IP address refused/',
                '/smtp;550 (.*) Poor Reputation Sender/i',
                '/smtp;554 (.*) Please submit an unblock request/i',
                '/smtp;554 5\.7\.1 You are not allowed to connect/i',
                '/smtp;554 Mail from (.*) refused, see RBL server/i',
                '/smtp;571 5\.7\.1 Message contains spam or virus or sender is blocked/i',
                '/smtp;554 (.*) found on one or more DNSBLs, see/i',
                '/smtp;550 5\.7\.1 (.*) RBL Restriction/i',
                '/smtp;571 Email from (.*) is currently blocked by/i',
                '/smtp;451 Could not load DRD for domain/i',
                '/smtp;450 Service temporarily unavailable; Client host (.*) blocked using/i',
                '/smtp;554 (.*) Client host (.*) blocked using/i',
                '/smtp;554 5\.2\.0 (.*) Spam content found/i',
                '/smtp;550 Recipient Rejected: Access Denied/i',
                '/smtp;550 (.*) Mail rejected/i',
                '/smtp;554 (.*) BLACKLIST/i',
                '/smtp;550 (.*) ALERTA/i',
                '/smtp;554 (.*) (unsolicited email|untrusted mail delivery system)/i',
                '/smtp;554 \(RTR:BL\)/i',
                '/smtp;550 5\.7\.1 Sorry, message looks like spam or phish/i',
                '/smtp;554 (.*) RBL Reject/i',
                '/smtp;553 (.*) DNSBL:ATTRBL/i',
                '/X-Unix; 1/i',
                '/smtp;(554|550) (.*) blocked/i',
                '/smtp;550 (.*) has been rejected/i',
                '/smtp;550 A URL in this email/i',
                '/smtp;550 (.*) IP has been found on a block(\s)?list/i',
                '/smtp;550 (.*) is blocked by/i',
                '/smtp;550 (.*) IP address is administratively disabled/i',
                '/smtp;554 (.*) rejected due to the bad reputation/i',
                '/smtp;550 Message refused by/i',
                '/smtp;554 5\.7\.1 Access denied/i',
                '/SMTP; 550-5\.7\.0 Message considered as spam or virus, rejected/i',
                '/smtp;550 5\.7\.606 Access denied/i',
                '/smtp;550 SPAM:/i',
                '/smtp;554 (.*) Rejected/i',
                '/smtp;550 (.*) is not allowed to send mail from/i',
                '/smtp;550 "JunkMail rejected/i',
                '/smtp;550 (.*)?Connection rejected. Your IP (.*) is in RBL/i',
                '/smtp;550 5\.7\.0 SPAM/i',
                '/smtp;554 5\.2\.0 (.*) Spam content found/i',
                '/smtp;554 (.*)?Connection refused/i',
                '/smtp;550 MFE: Message detected as spam/i',
                '/smtp;550 you are not allowed to send mail to/i',
                '/smtp;554 (.*) You are not allowed to send mail/i',
                '/smtp;550 5\.7\.0 Message considered as spam or virus/i',
                '/smtp;554 5\.5\.4 Your IP (.*) address has a bad reputation/i',
                '/smtp;554 (.*) Service not available No SMTP service IP address is black(\s)?listed/i',
                '/smtp;550 High probability of spam/i',
                '/smtp;550 A URL in this email/i',
                '/smtp;554 (.*) Please revise your message before resending./i',
                '/smtp;554 message refused by/i',
                '/smtp;552 (.*)? spam message rejected/i',
                '/smtp;550 (.*) Cyren AntiSpam/i',
                '/smtp;571 Delivery not authorized, message refused/i',
                '/smtp;550 (.*) Poor Reputation Sender/i',
                '/smtp;550 5\.7\.1 Recipients have complained about included content/i',
                '/smtp;553 Message filtered/i',
                '/smtp;554 5\.1\.0 Sender denied/i',
                '/smtp;550(.*)? REJECT(ed)?/i',
                '/smtp;554 (.*)(cloudmark|blocked)/i',
			),
		),
    	array(
