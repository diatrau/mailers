...
class MailerSwiftMailer extends MailerAbstract
{
    ...
    protected function setMessage(CMap $params)
    {
        ...
        // $message->setEncoder(Swift_Encoding::get8BitEncoding()); // since 1.3.6.0
        ...
        $message->getHeaders()->addTextHeader(sprintf('%sMailer', Yii::app()->params['email.custom.header.prefix']), 'SwiftMailer - ' . Swift::VERSION);
