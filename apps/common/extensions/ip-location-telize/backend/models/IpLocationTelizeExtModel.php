...
class IpLocationTelizeExtModel extends FormModel
{
    ...
    public function attributeLabels()
    {
        $labels = array(
            ...
            'status_on_customer_login'  => Yii::t('ext_ip_location_telize', 'Status on customer login'),
    ...
    public function attributeHelpTexts()
    {
        $texts = array(
            ...
            'status_on_customer_login'  => Yii::t('ext_ip_location_telize', 'Whether to collect ip location information when a customer logs in'),
