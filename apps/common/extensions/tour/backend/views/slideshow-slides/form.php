        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="pull-right">
                    ...
                    <?php } ?>
                    <?php echo CHtml::link(Yii::t('app', 'Cancel'), array('ext_tour_slideshow_slides/index', 'slideshow_id' => $slideshow->slideshow_id), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Cancel')));?>
                </div>
