...
class IpLocationFreegeoipExtModel extends FormModel
{
    ...
    public function attributeLabels()
    {
        $labels = array(
            ...
            'status_on_customer_login'  => Yii::t('ext_ip_location_freegeoip', 'Status on customer login'),
    ...
    public function attributeHelpTexts()
    {
        $texts = array(
            ...
            'status_on_customer_login'  => Yii::t('ext_ip_location_freegeoip', 'Whether to collect ip location information when a customer logs in'),
