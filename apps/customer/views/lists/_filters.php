...
<?php $form = $this->beginWidget('CActiveForm', array(
    ...
    'method'      => 'get',
    'action'      => '',
    'htmlOptions' => array('style' => 'display:' . ($filter->hasSetFilters ? 'block' : 'none')),
));?>
<hr />
<div class="box box-primary">
    ...
    <div class="box-footer">
        <div class="pull-right">
            <?php echo CHtml::submitButton(Yii::t('list_subscribers', 'Submit'), array('name' => '', 'class' => 'btn btn-primary'));?>
        </div>
        <div class="clearfix"><!-- --></div>
    </div>
</div>
