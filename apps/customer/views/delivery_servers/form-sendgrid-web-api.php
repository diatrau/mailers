...
if ($viewCollection->renderContent) {
    ...
    if ($collection->renderForm) {
        ...
        <div class="callout callout-info">
            ...
            <?php echo Yii::t('servers', 'The url where this server expects to receive webhooks requests to process bounces and complaints is: {url}', array('{url}' => sprintf('<strong>%s</strong>', $server->getDswhUrl())));?>
        </div>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="clearfix"><!-- --></div>
                <div class="form-group col-lg-4 hourly-block">
                    <div class="col-lg-6">
